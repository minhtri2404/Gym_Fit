                    ...
                    <div class="col-md-6 col-12 mx-auto">
                      ...
                      <form:form class="row" method="post" action="/admin/user/update" modelAttribute="user"
                        ...
                        <div class="col-md-6 col-12 mb-3">
                          ...
                          <input class="form-control" type="file" accept=".png, .jpg, .jpeg" name="userFile"
                            id="avatarFile" />
                        </div>
                        ...
                        <div class="col-12 mb-3 mx-auto">
                          <img src="/images/avatar/${user.avatar}" style="max-height: 250px;" alt="old avatar"
                            id="oldAvatar">
                        </div>
